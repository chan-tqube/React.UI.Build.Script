...
export const readDirectory = (pattern, options) => new Promise((resolve, reject) =>
  glob(pattern, options, (err, result) => (err ? reject(err) : resolve(result)));
);

export const makeDirectory = (name) => new Promise((resolve, reject) => {
...
export const cleanDirectory = (pattern, options) => new Promise((resolve, reject) =>
